...
int inc_threshold_1 = 110; //experimental value (variable)
...
int inc_threshold_2 = 110; //experimental value (variable)
...
int inc_threshold_3 = 110; //experimental value (variable)
...
int inc_threshold_4 = 110; //experimental value (variable)
            ...
            switch(FSM_status) {
              case RECOVERY:
                ...
                if (LL_sum1 <= base_threshold_1 &&
                    ...
                    LL_sum3 <= base_threshold_3 && lock_flag) {
                  FSM_status = BASELINE;
                  baseline_counter = 0;
                }
                break;
