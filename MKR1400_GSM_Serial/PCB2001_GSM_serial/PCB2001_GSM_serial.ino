...
//  WiFiClient client = server.available();   // listen for incoming clients
  ...
  //if (true) {  
    ...
    //while (client.connected()) {            // loop while the client's connected
      if (true) {//if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (true) { //if (c == '\n') {                    // if the byte is a newline character
          ...
          if (true) {//if (currentLine.length() == 0) {
            ...
            // dataline = dataline + " " + String(temperature);
            // dataline = dataline + " " + String(humidity);
            ...
            */
            ...
            // Serial.println(sizeof(dataline));
